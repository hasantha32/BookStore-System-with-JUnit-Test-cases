...
class GetMagazineByType_Test {
	...
	public void checkMagazineStore_isNullbyTitle() {
		...
		Magazine actualMagazine = magazineService.getMagazineByType("Learning");
	//	Book actualMagazine = magazineService.getBookByAuthor("Food");
		
		assertNull(actualMagazine, "Your selected type magazine/magazines available in magazinestore!! ,Magazine is not null!!!");
	}
